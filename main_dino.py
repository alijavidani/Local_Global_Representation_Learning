...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default=f"/home/alij/RESULTS/Cifar10/Ours/Network_Checkpoints/ali_batch40_on_gpu", type=str, help='Path to save logs and checkpoints.')
